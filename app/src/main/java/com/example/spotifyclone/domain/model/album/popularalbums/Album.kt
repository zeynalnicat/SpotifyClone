...
data class Album(
    ...
    val copyrights: List<com.example.spotifyclone.domain.model.album.popularalbums.Copyright>,
    val external_ids: com.example.spotifyclone.domain.model.album.popularalbums.ExternalIds,
    ...
    val tracks: com.example.spotifyclone.domain.model.album.popularalbums.Tracks,
    val type: String,
    val uri: String
)